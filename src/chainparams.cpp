...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 2238;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Zodiac starting difficulty is 1 / 2^12
		...
		nTargetTimespan = 1 * 60; // Zodiac: 1 day
        nTargetSpacing = 1 * 60;  // Zodiac: 1 minute
        nLastPOWBlock = 200;
        ...
        vSeeds.push_back(CDNSSeedData("clubs.seed.zodiac.io", "clubs.seed.zodiac.io"));
        vSeeds.push_back(CDNSSeedData("hearts.seed.zodiac.io", "hearts.seed.zodiac.io"));
        vSeeds.push_back(CDNSSeedData("diamonds.seed.zodiac.io", "diamonds.seed.zodiac.io"));
        vSeeds.push_back(CDNSSeedData("spades.seed.zodiac.io", "spades.seed.zodiac.io"));
...
public:
    CTestNetParams()
    {
		...
		base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet zodiac addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet zodiac script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);      // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet zodiac BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet zodiac BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet zodiac BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Zodiac: 1 day
        nTargetSpacing = 1 * 60;        // Zodiac: 1 minutes
