/* src/config/zodiac-config.h.  Generated from zodiac-config.h.in by configure.  */
/* src/config/zodiac-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.zodiaccoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Zodiac Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Zodiac Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zodiac"
