...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Zodiac Core zodiac-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zodiac-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zodiac transaction") + "\n" +
                               "  zodiac-tx [options] -create [commands]   " + _("Create hex-encoded zodiac transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zodiac transaction
