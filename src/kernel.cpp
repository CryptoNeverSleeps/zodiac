...
{
    return nIntervalEnd - nIntervalBeginning - StakeMinAgev2();
}
...
{
    //Zodiac will hash in the transaction hash and the index number in order to make sure each hash is unique
