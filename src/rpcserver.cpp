...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zodiac features */
        {"zodiac", "masternode", &masternode, true, true, false},
        {"zodiac", "listmasternodes", &listmasternodes, true, true, false},
        {"zodiac", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"zodiac", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"zodiac", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"zodiac", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zodiac", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zodiac", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zodiac", "masternodedebug", &masternodedebug, true, true, false},
        {"zodiac", "startmasternode", &startmasternode, true, true, false},
        {"zodiac", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zodiac", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zodiac", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zodiac", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zodiac", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zodiac", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zodiac", "mnbudget", &mnbudget, true, true, false},
        {"zodiac", "preparebudget", &preparebudget, true, true, false},
        {"zodiac", "submitbudget", &submitbudget, true, true, false},
        {"zodiac", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zodiac", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zodiac", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zodiac", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zodiac", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zodiac", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zodiac", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zodiac", "checkbudgets", &checkbudgets, true, true, false},
        {"zodiac", "mnsync", &mnsync, true, true, false},
        {"zodiac", "spork", &spork, true, true, false},
        {"zodiac", "getpoolinfo", &getpoolinfo, true, true, false},
        {"zodiac", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
        ...
        {"zerocoin", "getzzdcseed", &getzzdcseed, false, false, true},
        {"zerocoin", "setzzdcseed", &setzzdcseed, false, false, true}
...
{
    return "> zodiac-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2239/\n";
}
