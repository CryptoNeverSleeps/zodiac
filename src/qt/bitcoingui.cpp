                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Zodiac Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    labelEncryptionIcon->setStyleSheet(".QPushButton { background: transparent;}");
    ...
    labelConnectionsIcon->setStyleSheet(".QPushButton { background: transparent;}");
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zodiac address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zodiac: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zZDC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zodiac Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zodiac Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zodiac"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zodiac addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zodiac addresses"));
    ...
    openAction->setStatusTip(tr("Open a Zodiac: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zodiac Core help message to get a list with possible Zodiac command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        header->setPixmap(QPixmap(":/images/zodiac_logo_horizontal"));
        header->setCursor(Qt::PointingHandCursor);
        QObject::connect(header , SIGNAL(onClick()), this, SLOT(linkzodiacClickedSlot()));
...
{   
    ...
    QNetworkReply *reply = manager.get(QNetworkRequest(QUrl(QString("https://wallet.zodiac.io/ads/%1.png").arg(unixtime))));
...
void BitcoinGUI::linkzodiacClickedSlot()
{
    QDesktopServices::openUrl(QUrl("https://zodiac.io/" ));
}
void BitcoinGUI::linkClickedSlot()
{
    QDateTime currentDateTime = QDateTime::currentDateTime();
    uint unixtime = currentDateTime.toTime_t() / 30;
    QDesktopServices::openUrl(QUrl( QString("https://zodiac.io/go/%1").arg(unixtime) ));
}
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zodiac Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zodiac network", "", count));
}
...
{
    QString strTitle = tr("Zodiac Core"); // default title
