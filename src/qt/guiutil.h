...
/** Utility functions used by the Zodiac Qt UI.
 */
namespace GUIUtil
{
...
// Render Zodiac addresses in monospace font
...
// Parse "zodiac:" URI into recipient object, return true on successful parsing
