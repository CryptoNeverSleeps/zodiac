 ...
 */
    ...
    typeWidget->addItem(tr("Received Zdc from zZdc"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zZdc"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zZdc));
