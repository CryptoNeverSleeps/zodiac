...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(ZDC);
    unitlist.append(mZDC);
    unitlist.append(uZDC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case ZDC:
        return QString("zodiac");
    case mZDC:
        return QString("mzodiac");
    case uZDC:
        return QString::fromUtf8("uzodiac");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ZDC:
            return QString("tZDC");
        case mZDC:
            return QString("mtZDC");
        case uZDC:
            return QString::fromUtf8("μtZDC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ZDC:
            return QString("ZDC");
        case mZDC:
            return QString("Milli-ZDC (1 / 1" THIN_SP_UTF8 "000)");
        case uZDC:
            return QString("Micro-ZDC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case ZDC:
            return QString("TestZDCs");
        case mZDC:
            return QString("Milli-TestZDC (1 / 1" THIN_SP_UTF8 "000)");
        case uZDC:
            return QString("Micro-TestZDC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
