                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzzdcPathCustom = GetArg("-zzdcbackuppath", "");
    ...
    if(!strzzdcPathCustom.empty()) {
        ui->wallet_customzzdcbackuppath->setText(QString::fromStdString(strzzdcPathCustom));
        ui->wallet_customzzdcbackuppath_label->setVisible(true);
        ui->wallet_customzzdcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzzdcPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to The Zodiac RPC console.") + "<br>" + 
