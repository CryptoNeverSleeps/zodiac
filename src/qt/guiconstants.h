...
/* Zodiac GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Zodiac"
#define QAPP_ORG_DOMAIN "zodiac.org"
#define QAPP_APP_NAME_DEFAULT "Zodiac-Qt"
#define QAPP_APP_NAME_TESTNET "Zodiac-Qt-testnet"
