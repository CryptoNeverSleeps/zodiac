...
#ifndef ZODIAC_ZZDCWALLET_H
#define ZODIAC_ZZDCWALLET_H
...
public:
    CzZDCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZZDC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZZDC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //ZODIAC_ZZDCWALLET_H
