...
RESOURCES += src/qt/zodiac.qrc src/qt/zodiac_locale.qrc

TRANSLATIONS += src/qt/locale/zodiac_bg.ts \
                src/qt/locale/zodiac_de.ts \
                src/qt/locale/zodiac_en.ts \
                src/qt/locale/zodiac_es.ts \
                src/qt/locale/zodiac_fi.ts \
                src/qt/locale/zodiac_fr.ts \
                src/qt/locale/zodiac_it.ts \
                src/qt/locale/zodiac_ja.ts \
                src/qt/locale/zodiac_pl.ts \
                src/qt/locale/zodiac_pt.ts \
                src/qt/locale/zodiac_ru.ts \
                src/qt/locale/zodiac_sk.ts \
                src/qt/locale/zodiac_sv.ts \
                src/qt/locale/zodiac_vi.ts \
                src/qt/locale/zodiac_zh_CN.ts \
                src/qt/locale/zodiac_zh_TW.ts
