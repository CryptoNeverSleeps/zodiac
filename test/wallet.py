...
#   c) node1 mines 32 blocks, so now node 0 has 60001zdc, node 1 has 4250zdc, node2 has none.
#   d) node0 sends 601 zdc to node2, in two transactions (301 zdc, then 300 zdc).
