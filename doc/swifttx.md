...
This mechanism has been integrated into Bitcore-Node-Zodiac which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zodiacproject/insight-api-zodiac#web-socket-api](https://github.com/zodiacproject/insight-api-zodiac#web-socket-api) 
* API: [https://github.com/zodiacproject/insight-api-zodiac#swifttx-transactions](https://github.com/zodiacproject/insight-api-zodiac#swifttx-transactions) 
...
By default, the Zodiac Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zodiac Core daemon:
