...
In order to support loading of multiple wallets in zodiac-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zodiac.cpp.
...
Changes to zodiac.cpp
----------------------
zodiac.cpp is the entry point into zodiac-qt, and as such, will require some minor modifications to provide hooks for
