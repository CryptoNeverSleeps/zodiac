Contributing to Zodiac Core
============================

The Zodiac Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zodiac Core project, and is not to be
confused with overall Zodiac Network Protocol consensus changes.

Whether a pull request is merged into Zodiac Core rests with the project merge
...
Patches that change Zodiac consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zodiac consensus, it must have been
...
The project leader is the release manager for each Zodiac Core release.
